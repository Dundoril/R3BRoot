#ifndef R3BFibHITITEM_H
#define R3BFibHITITEM_H
...
class R3BFibHitItem : public R3BHit
{
 public:
  // Default Constructor
  R3BFibHitItem();
  ...
  R3BFibHitItem(UInt_t detector, UInt_t fiber, Float_t xpos, Float_t ypos, Float_t zpos, //pos
		Float_t energy_top, Float_t energy_bottom,                               //energy
		Float_t time_top, Float_t time_bottom);                                  //time
    
  // Destructor
  virtual ~R3BFibHitItem() { }
