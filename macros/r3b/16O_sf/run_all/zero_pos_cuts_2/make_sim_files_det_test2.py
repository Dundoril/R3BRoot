...
class SimFiles():
		...
		with open(master) as inf:
			for line in inf:
				if "Double_t" in line and "distanceZeroDet" in line:
					...
					self.line_randomSeed = self._read_val_line(line)
	...
	def set_targetType(self, val):
		if self.line_target_change == val:
			...
			self.line_target_type = self.line_target_type.replace(".geo.root", "_{}.geo.root".format(val))
...
if __name__ == "__main__":
	...
	for i in range(10):
		...
		if i == 0:
			sim_inst.set_fi7_8Distance(9.5)
		elif i == 1:
			sim_inst.set_fi7_8Distance(10)
		elif i == 2:
			sim_inst.set_fi7_8Distance(10.5)
		elif i == 3:
			sim_inst.set_fi7_8Distance(11)
		elif i == 4:
			sim_inst.set_fi7_8Distance(11.5)
		else:
		...
		#Det 10/11
		if i == 5:
			sim_inst.set_fi10_11Distance(8)
		elif i == 6:
			sim_inst.set_fi10_11Distance(8.5)
		elif i == 7:
			sim_inst.set_fi10_11Distance(9)
		elif i == 8:
			sim_inst.set_fi10_11Distance(9.5)
		elif i == 9:
			sim_inst.set_fi10_11Distance(10)
		else:
			sim_inst.set_fi10_11Distance(1000)
