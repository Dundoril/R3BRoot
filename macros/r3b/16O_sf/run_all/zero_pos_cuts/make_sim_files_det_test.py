...
if __name__ == "__main__":
	...
	for i in range(11):
		...
		if i == 0:
			...
			sim_inst.set_fi3Distance(1.4)
		elif i == 2:
			sim_inst.set_fi3Distance(1.5)
		else:
		...
		if i == 3:
			sim_inst.set_fi7_8Distance(7)
		elif i == 4:
			sim_inst.set_fi7_8Distance(7.5)
		elif i == 5:
			sim_inst.set_fi7_8Distance(8)
		elif i == 6:
			sim_inst.set_fi7_8Distance(8.5)
		elif i == 7:
			sim_inst.set_fi7_8Distance(9)
		else:
		...
		#Det 10/11
		if i == 8:
			sim_inst.set_fi10_11Distance(6.5)
		elif i == 9:
			sim_inst.set_fi10_11Distance(7)
		elif i == 10:
			sim_inst.set_fi10_11Distance(7.5)
		else:
