...
if __name__ == "__main__":
	...
	for i in range(10):
		...
		if i == 0:
			sim_inst.set_fi7_8Distance(12)
		elif i == 1:
			sim_inst.set_fi7_8Distance(12.5)
		elif i == 2:
			sim_inst.set_fi7_8Distance(13)
		elif i == 3:
			sim_inst.set_fi7_8Distance(13.5)
		elif i == 4:
			sim_inst.set_fi7_8Distance(14)
		else:
		...
		#Det 10/11
		if i == 5:
			sim_inst.set_fi10_11Distance(10.5)
		elif i == 6:
			sim_inst.set_fi10_11Distance(11)
		elif i == 7:
			sim_inst.set_fi10_11Distance(11.5)
		elif i == 8:
			sim_inst.set_fi10_11Distance(12)
		elif i == 9:
			sim_inst.set_fi10_11Distance(12.5)
		else:
