...
if __name__ == "__main__":
	...
	for i in range(14):
		...
		if i == 0:
			sim_inst.set_fi3Distance(0.0)
		elif i == 1:
			sim_inst.set_fi3Distance(0.6)
		elif i == 2:
			sim_inst.set_fi3Distance(0.8)
		elif i == 3:
			sim_inst.set_fi3Distance(1.0)
		else:
		...
		if i == 4:
			sim_inst.set_fi7_8Distance(0)
		elif i == 5:
			sim_inst.set_fi7_8Distance(6)
		elif i == 6:
			sim_inst.set_fi7_8Distance(6.5)
		elif i == 7:
			sim_inst.set_fi7_8Distance(7)
		elif i == 8:
			sim_inst.set_fi7_8Distance(7.5)
		elif i == 9:
			sim_inst.set_fi7_8Distance(8.0)
		else:
		...
		if i == 10:
			...
			sim_inst.set_fi10_11Distance(5)
		elif i == 12:
			sim_inst.set_fi10_11Distance(6)
		elif i == 13:
