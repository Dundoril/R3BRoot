void run_sim()
{
    ...
    Bool_t magnet = kTRUE;
    Float_t fieldScale = -0.541; // 500 AMeV;
...
// 
    ...
    run->AddModule(new R3BFi3b("fi3b_16O.geo.root", {-fi3Distance+6.1, 0.00, distanceZeroDet- 10}, {"" ,-90.,90.,0.0}));

    // Fi7 detector
    Double_t fi7_8Distance = 25.0;
    ...
    run->AddModule(new R3BFi7("fi7_16O.geo.root",{fi7X-20.52, 0.0,fi7Z-15 }, {"" ,90.0,90.0-18.0,0.0}));
    ...
    run->AddModule(new R3BFi8("fi8_16O.geo.root",{fi8X, 0.0,fi8Z }, {"" ,90.0,90.0-18.0,0.0}));

    // Fi10 detector
    Double_t fi10_11Distance = 30.0;
    ...
    run->AddModule(new R3BFi10("fi10_16O.geo.root", {fi10X -20.513, 0.0,fi10Z -10 }, {"" ,90.0,90.0-18.0,0.0}));
    ...
    run->AddModule(new R3BFi11("fi11_16O.geo.root", {fi11X, 0.0, fi11Z }, {"" ,90.0,90.0-18.0,0.0}));
