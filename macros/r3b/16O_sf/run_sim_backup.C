void run_sim()
{
    ...
    // Fi3a detector
   // run->AddModule(new R3BFi3a("fi3a_16O.geo.root", {+73.274339-(TMath::Cos(TMath::DegToRad()*18.0))*300.0, 0.00, 600.0+TMath::Sin(TMath::DegToRad()*18.0)*300.0}, {"" ,90.,90-18.0,0.0}));
    

    distanceZeroMagnet = 300.0 ;




    fi3Distance =10; 
    fi3DistanceMagnetDetectors = 300.0;

    fi3aX = -(TMath::Sin(TMath::DegToRad()*18.0))*fi3DistanceMagnetDetectors                      +  TMath::Cos(TMath::DegToRad()*18.0)*fi3Distance;
    fi3aY =  (TMath::Cos(TMath::DegToRad()*18.0))*fi3DistanceMagnetDetectors + distanceZeroMagnet +  TMath::Sin(TMath::DegToRad()*18.0)*fi3Distance;
    run->AddModule(new R3BFi3a("fi3a_16O.geo.root", {fi3aX, 0.00, fi3aY}, {"" ,90.,90-18.0,0.0}));


    fi3bX = -(TMath::Sin(TMath::DegToRad()*18.0))*fi3DistanceMagnetDetectors                      -  TMath::Cos(TMath::DegToRad()*18.0)*fi3Distance;
    fi3bY =  (TMath::Cos(TMath::DegToRad()*18.0))*fi3DistanceMagnetDetectors + distanceZeroMagnet -  TMath::Sin(TMath::DegToRad()*18.0)*fi3DistanceÃ;
    run->AddModule(new R3BFi3b("fi3b_16O.geo.root", {fi3bX, 0.00, fi3bY}, {"" ,90.,90-18.0,0.0}));   
    // Fi3b detector


   // run->AddModule(new R3BFi3a("fi3b_16O.geo.root", {+73.274339-(TMath::Cos(TMath::DegToRad()*18.0))*300.0, 0.00, 600.0+TMath::Sin(TMath::DegToRad()*18.0)*300.0}, {"" ,90.,90-18.0,0.0}));
    ...
    // Fi7 detector
  //  run->AddModule(new R3BFi7("fi7_16O.geo.root",-150., 0.0, 700.,-45));

    // Fi8 detector
    //run->AddModule(new R3BFi8("fi8_16O.geo.root",-180., 0.0, 700.,-45));

    // Fi10 detector
    //run->AddModule(new R3BFi10("fi10_16O.geo.root", {-73.274339-TMath::Tan(TMath::DegToRad()*0.0)*100, 0.069976, 513.649524+400.}, {"" ,0.0,0.0,45.0}));



   // fi10_11Distance = 30; 
   // fi10_11DistanceMagnetDetectors = 300.0;

    //fi10X = -(TMath::Sin(TMath::DegToRad()*18.0))*distanceZeroMagnet  +  TMath::Cos(TMath::DegToRad()*18.0)*fi10_11Distance;
    //fi10Y =  TMath::Cos(TMath::DegToRad()*18.0)*distanceZeroMagnet  +  TMath::Sin(TMath::DegToRad()*18.0)*fi10_11Distance;

    run->AddModule(new R3BFi10("fi10_16O.geo.root", {-73.274339-TMath::Tan(TMath::DegToRad()*0.0)*100, 0.069976, 513.649524+400.}, {"" ,0.0,0.0,0.0}));
    // Fi11 detector
    run->AddModule(new R3BFi11("fi11_16O.geo.root", {-73.274339-TMath::Tan(TMath::DegToRad()*0.0)*100, 3.069976, 513.649524+400.}, {"" ,0,0.0,0.0}));
