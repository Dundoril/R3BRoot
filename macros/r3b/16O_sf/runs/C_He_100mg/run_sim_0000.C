void run_sim_0000()
{
    ...
    TString outFile = "sim_0000.root";
    TString parFile = "par_0000.root";
...
// 
    ...
    run->AddModule(new R3BTarget(targetType, "target_" + targetType + "_0mg.geo.root", {distanceZeroTarget, 0.00, 0.}, {"",0.,0.,0.0}));
