void run_sim_0002()
{
    ...
    TString outFile = "sim_0002.root";
    TString parFile = "par_0002.root";
...
// 
    ...
    run->AddModule(new R3BTarget(targetType, "target_" + targetType + "_100mg.geo.root", {distanceZeroTarget, 0.00, 0.}, {"",0.,0.,0.0}));
    ...
    // Fi10 detector
    Double_t fi10_11Distance = 37.88;
