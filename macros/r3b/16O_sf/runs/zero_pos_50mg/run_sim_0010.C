void run_sim_0010()
{
    ...
    TString outFile = "sim_0010.root";
    TString parFile = "par_0010.root";
...
// 
    ...
    run->AddModule(new R3BTarget(targetType, "target_" + targetType + "_50mg.geo.root", {distanceZeroTarget, 0.00, 0.}, {"",0.,0.,0.0}));
    ...
    // Fi7 detector
    Double_t fi7_8Distance = 1026.25;
    ...
    // Fi10 detector
    Double_t fi10_11Distance = 26.88;
