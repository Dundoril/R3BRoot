void run_sim_0003()
{
    ...
    TString outFile = "sim_0003.root";
    TString parFile = "par_0003.root";
...
// 
    ...
    run->AddModule(new R3BTarget(targetType, "target_" + targetType + "_150mg.geo.root", {distanceZeroTarget, 0.00, 0.}, {"",0.,0.,0.0}));
