void run_sim_0004()
{
    ...
    TString outFile = "sim_0004.root";
    TString parFile = "par_0004.root";
    ...
    TString inputFile = "evt_gen_16O_500AMeV_1MeV_1e6.dat";
...
// 
    ...
    run->AddModule(new R3BTarget(targetType, "target_" + targetType + "_200mg.geo.root", {distanceZeroTarget, 0.00, 0.}, {"",0.,0.,0.0}));
    ...
    // Fi10 detector
    Double_t fi10_11Distance = 33.88;
