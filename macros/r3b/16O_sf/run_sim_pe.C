void run_sim()
{
   ...
   // run->AddModule(new R3BFi3a("fi3a_16O.geo.root", {+73.274339-(TMath::Cos(TMath::DegToRad()*18.0))*300.0, 0.00, 600.0+TMath::Sin(TMath::DegToRad()*18.0)*300.0}, {"" ,90.,90-18.0,0.0}));
    ...
    Doubel_t distanceZeroMagnet = 300.0 ;
    Doubel_t fi3Distance =10.0; 
    Doubel_t fi3DistanceMagnetDetectors = 300.0;
    ...
    // Doubel_t fi3aX = -(TMath::Sin(TMath::DegToRad()*18.0))*fi3DistanceMagnetDetectors                      +  TMath::Cos(TMath::DegToRad()*18.0)*fi3Distance;
    // Doubel_t fi3aY =  (TMath::Cos(TMath::DegToRad()*18.0))*fi3DistanceMagnetDetectors + distanceZeroMagnet +  TMath::Sin(TMath::DegToRad()*18.0)*fi3Distance;
    // run->AddModule(new R3BFi3a("fi3a_16O.geo.root", {fi3aX, 0.00, fi3aY}, {"" ,90.,90-18.0,0.0}));


    // Doubel_t fi3bX = -(TMath::Sin(TMath::DegToRad()*18.0))*fi3DistanceMagnetDetectors                      -  TMath::Cos(TMath::DegToRad()*18.0)*fi3Distance;
    // Doubel_t fi3bY =  (TMath::Cos(TMath::DegToRad()*18.0))*fi3DistanceMagnetDetectors + distanceZeroMagnet -  TMath::Sin(TMath::DegToRad()*18.0)*fi3Distance;
  ...
  //  run->AddModule(new R3BFi7("fi7_16O.geo.root",-150., 0.0, 700.,-45));
    ...
    // Fi10 detector
    // fi10_11Distance = 30; 
    // fi10_11DistanceMagnetDetectors = 400.0;

    // fi10X = -(TMath::Sin(TMath::DegToRad()*18.0))*fi10_11DistanceMagnetDetectors                       +  TMath::Cos(TMath::DegToRad()*18.0)*fi10_11Distance;
    // fi10Y =  (TMath::Cos(TMath::DegToRad()*18.0))*fi10_11DistanceMagnetDetectors + distanceZeroMagnet  +  TMath::Sin(TMath::DegToRad()*18.0)*fi10_11Distance;
    // run->AddModule(new R3BFi10("fi10_16O.geo.root", {fi10X, 0.0,fi10Y }, {"" ,90.0,90.0-18,0.0}));
    ...
    // fi11Y =  (TMath::Cos(TMath::DegToRad()*18.0))*fi10_11DistanceMagnetDetectors + distanceZeroMagnet  -  TMath::Sin(TMath::DegToRad()*18.0)*fi10_11Distance;
    // run->AddModule(new R3BFi11("fi11_16O.geo.root", {fi11X, 0.0, fi11Y }, {"" ,90,90-18.0,0.0}));
