...
//  detGeo.Add(new TObjString("ALADIN"),        new TObjString("aladin_v13a.geo.root"));
  detGeo.Add(new TObjString("GLAD"),          new TObjString("glad_16O.geo.root"));
//  detGeo.Add(new TObjString("CRYSTALBALL"),   new TObjString("cal_v13a.geo.root"));
  detGeo.Add(new TObjString("CALIFA"),        new TObjString("califa_s2018.geo.root"));
...
//  detGeo.Add(new TObjString("TOF"),           new TObjString("tof_v13a.geo.root"));
  detGeo.Add(new TObjString("MTOF"),          new TObjString("mtof_s2018.geo.root"));
...
//  detGeo.Add(new TObjString("STaRTrack"),     new TObjString("startra_v13a.geo.root"));
  detGeo.Add(new TObjString("GFI"),           new TObjString("gfi_s2018.geo.root"));
//  detGeo.Add(new TObjString("LAND"),          new TObjString("land_v12a_10m.geo.root"));
  detGeo.Add(new TObjString("SCINTNEULAND"),  new TObjString("neuland_s2018.geo.root"));
...
//  detGeo.Add(new TObjString("MFI"),           new TObjString("mfi_16O.geo.root"));
