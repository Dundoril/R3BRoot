...
//    TString filename = "/d/land2/kvi2018/lmd/run"+runNumber+"*.lmd";
    TString outputFileName = "/u/mheil/nyx/mheil2/data/kvi2018/rootfiles/tcal_ptof_"+runNumber+".root";
...
#define RUN_ONLINE
	...
	parOut2->open("tcal_ptof_"+runNumber+".root");
