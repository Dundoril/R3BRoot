...
// 	TString filename = "/SAT/nyx/land/jun2016/lmd/run"+runNumber+"*.lmd";

    TString filename = "/SAT/nyx/land/jun2016/stitched/run"+runNumber+"_*.lmd";

	TString outputFileName = "/u/kelic/R3BRoot/macros/r3b/unpack/june2016/run"+ runNumber + "_los_time_cal.root";
//	TString outputFileName = "/SAT/hera/land/jun2016/rootfiles/run"+ runNumber + "_los_time_cal_a.root";
	TString ntuple_options = "UNPACK:EVENTNO,UNPACK:TRIGGER,RAW";
	TString ucesb_dir = getenv("UCESB_DIR");
	TString ucesb_path = ucesb_dir + "/../upexps/jun16C/jun16C";
