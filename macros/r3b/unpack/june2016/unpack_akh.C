...
#include "/u/mheil/R3BRoot/r3bsource/ext_h101.h"

}

void unpack_akh(Int_t RunId)
{
//    Int_t RunId=100;
   ...
   TStopwatch timer;
    ...
    const Int_t nev = 1000000 ; /* number of events to read, -1 - until CTRL+C */
...
//    TString filename = "stream://lxfs186:8000";
    ...
    TString outputFileName = "/SAT/hera/land/jun2016/rootfiles/run"+runNumber + "_los_tofd1_hit.root";
...
/*    R3BAladinFieldMap* magField = new R3BAladinFieldMap("AladinMaps");
    ...
    */
    ...
    {
		printf("Using run < 54\n");
		r3bOnlineSpectra->SetLosParameters(-2.15, -1.28,5.3, 5.2); // Set offset and effective speeds of light in x, y 
	}
	else if(RunId >= 54 && RunId < 67)
    {
		printf("Using run >= 54\n");
   /* Parameter set after problems with LOS_4 */
		r3bOnlineSpectra->SetLosParameters(-2.126, -4.285, 5.3, 5.2); // Set offset and effective speed of light in x, y 
    }
        else
    {
		r3bOnlineSpectra->SetLosParameters(-2.099, -2.65, 5.3, 5.2); // Set offset and effective speed of light in x, y 
