...
//      Int_t RunId=100;
	...
	TString outputFileName = "/u/mheil/R3BRoot/macros/r3b/unpack/june2016/run"+ runNumber + "_los_time_cal.root";
...
/*	R3BAladinFieldMap* magField = new R3BAladinFieldMap("AladinMaps");
	...
	*/
    ...
    losCalibrator->SetNofModules(2, 5); // dets, bars(incl. master trigger)
