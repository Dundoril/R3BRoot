...
//	TString filename = "stream://x86l-77";
//	TString filename = "/SAT/nyx/land/mheil/ptof/lmd/pulser000.lmd";
	
	TString filename = "/d/land2/mheil/ptof/lmd/run" + runNumber + ".lmd";
//	TString filename = "/u/mheil/nyx/mheil/ptof/lmd/run" + runNumber + ".lmd";
/*	
...
#define USE_HTTP_SERVER
	...
	parList->Add(new TObjString("ptof_cal_params_run200.root"));
