void run_sim()
{
    ...
    // PSP
    run->AddModule(new R3BPsp("psp_test.geo.root", {}, -221., -89., 94.1));
...
//    run->AddModule(new R3BFi6("fi6_OneLayer_c.geo.root", { -154.5, 0., 771.4 }, { "", 90., 27., 90. })); 
    ...
    {
        R3BIonGenerator* boxGen = new R3BIonGenerator(28, 58, 28, 1, 0., 0., 1.087);//500 AMeV
	boxGen->SetSpotRadius(1.,0.,1.);
