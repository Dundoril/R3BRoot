...
void r3ball(Int_t nEvents = 1,
            ...
            TString InFile = "evt_gen_16O_500AMeV_1MeV.dat")
{
...
//  Double_t fieldScale = -0.327; // 300 MeV
  Double_t fieldScale = -0.4412; // 500 MeV
//   Double_t fieldScale = -0.542; // 600 MeV
//  Double_t fieldScale = -0.59; // 800 MeV
//  Double_t fieldScale = -0.69; // 1000 MeV
  ...
  if (fGenerator.CompareTo("box") == 0  ) {
    ...
    // 16O fragment
//    R3BIonGenerator* ionGen = new R3BIonGenerator(8, 16, 8, 1, 0., 0., 1.69204); // 1000 AMeV
//    R3BIonGenerator* ionGen = new R3BIonGenerator(8, 16, 8, 1, 0., 0., 1.45959); // 800 AMeV
//    R3BIonGenerator* ionGen = new R3BIonGenerator(8, 16, 8, 1, 0., 0., 1.2156488); // 600 AMeV
//    R3BIonGenerator* ionGen = new R3BIonGenerator(8, 16, 8, 1, 0., 0., 0.9514); // 400 AMeV
//    R3BIonGenerator* ionGen = new R3BIonGenerator(8, 16, 8, 1, 0., 0., 1.086969); // 500 AMeV
    R3BIonGenerator* ionGen = new R3BIonGenerator(8, 16, 8, 1, 0., 0., 1.087628); // 500 AMeV
//    R3BIonGenerator* ionGen = new R3BIonGenerator(8, 16, 8, 1, 0., 0., 0.8055); // 300 AMeV

// 12C
//    R3BIonGenerator* ionGen = new R3BIonGenerator(6, 12, 6, 1, 0.007475, 0., 1.086969); // 500 AMeV
//    R3BIonGenerator* ionGen = new R3BIonGenerator(6, 12, 6, 1, 0., 0., 1.086969+0.007475); // 500 AMeV
    ionGen->SetSpotRadius(0.2, -100., 1.);
