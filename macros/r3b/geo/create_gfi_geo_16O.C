...
void create_gfi_geo_16O(const char* geoTag)
{
  ...
  dx = -172.2; 
  dy = 0.0;
  dz = 700.0; //200 from target to center of GLAD + the distance after center
  
  // Rotation:
  thx = -108.000000;    phx = 0.000000;
  //   thx = 106.700000;    phx = 0.000000;
  thy = 90.000000;    phy = 90.000000;
  thz = -18.00000;    phz = 0.000000;
  ...
  dx = -120.; 
  dy = 0.0;
  dz = 718.0; //200 from target to center of GLAD + the distance after center
