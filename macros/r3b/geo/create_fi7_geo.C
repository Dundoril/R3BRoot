...
void create_fi7_geo(const char* geoTag)
{
  ...
  TString geoFileName = geoPath + "/geometry/fi7_";
  ...
  TGeoVolume*   pGFILogWorld = new TGeoVolumeAssembly("FI7LogWorld");
  ...
  TGeoVolume* pGFILog = new TGeoVolume("FI7Log",pGFIBox, pMed35);
  ...
  TGeoVolume* pGFILogActive = new TGeoVolume("FI71Log",pGFIBoxActive,pMed35);
  ...
  pGFILogActive->SetLineColor(kRed);
