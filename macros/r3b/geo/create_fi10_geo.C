...
void create_fi10_geo(const char* geoTag)
{
  ...
  TString geoFileName = geoPath + "/geometry/fi10_";
  ...
  TGeoVolume*   pGFILogWorld = new TGeoVolumeAssembly("FI10LogWorld");
  ...
  TGeoVolume* pGFILog = new TGeoVolume("FI10Log",pGFIBox, pMed35);
  ...
  TGeoVolume* pGFILogActive = new TGeoVolume("FI101Log",pGFIBoxActive,pMed35);
  ...
  pGFILogActive->SetLineColor(kViolet);
