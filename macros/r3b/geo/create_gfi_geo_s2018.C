...
void create_gfi_geo(const char* geoTag)
{
  ...
  // -------   Geometry file name (outpucreate_gfi_geo_s2018.Ct)   ----------------------------------
  ...
  dx = -110.; //dE tracker, correction due to wrong angle
  dy = 0.0;
  dz = 600.;
  ...
  dx = -170.; //dE tracker, correction due to wrong angle
  dy = 0.0;
  dz = 800.;
