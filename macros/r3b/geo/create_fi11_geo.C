...
void create_fi11_geo(const char* geoTag)
{
  ...
  TGeoVolume*   pGFILogWorld = new TGeoVolumeAssembly("FI11LogWorld");
  ...
  TGeoVolume* pGFILog = new TGeoVolume("FI11Log",pGFIBox, pMed35);
  ...
  TGeoVolume* pGFILogActive = new TGeoVolume("FI111Log",pGFIBoxActive,pMed35);
  ...
  pGFILogActive->SetLineColor(kGray);
