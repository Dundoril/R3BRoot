...
void create_fi3b_geo(const char* geoTag)
{
  ...
  TString geoFileName = geoPath + "/geometry/fi3b_";
  ...
  TGeoVolume*   pGFILogWorld = new TGeoVolumeAssembly("FI3BLogWorld");
  ...
  TGeoVolume* pGFILog = new TGeoVolume("FI3BLog",pGFIBox, pMed35);
  ...
  TGeoVolume* pGFILogActive = new TGeoVolume("FI3B1Log",pGFIBoxActive,pMed35);
  ...
  pGFILogActive->SetLineColor(kOrange);
