void run_sim()
{
    ...
    TString inputFile = "evt_gen_4n.dat";
    ...
    // GLAD
    run->AddModule(new R3BGladMagnet("GladMagnet", "glad_v17_flange.geo.root", "R3BGlad Magnet")); // GLAD should not be moved or rotated
    ...
    // GFI detector
    //run->AddModule(new R3BGfi("Gfi","gfi_16O.geo.root", kTRUE,                             -172.2, 0.0, 750., -18., -120., 0.0, 768., -18.));
