...
//    run->AddModule(new R3BGladMagnet("glad_v17_flange.geo.root")); // GLAD should not be moved or rotated
    ...
    // LOS
//    run->AddModule(new R3BLos("los_KVI.geo.root", {}, -221., -89., 94.1));

    // PSP
    run->AddModule(new R3BPsp("psp_KVI1.geo.root", {}, -100., -90., -80.));
    ...
    // Fiber
//    run->AddModule(new R3BFi4("fi4_v17a.geo.root", { -92.70, 0., 571.4 }, { "", 90., -18., 90. })); 
//    run->AddModule(new R3BFi5("fi5_v17a.geo.root", { -123.6, 0., 671.4 }, { "", 90., -18., 90. })); 
//    run->AddModule(new R3BFi6("fi6_v17a.geo.root", { -154.5, 0., 771.4 }, { "", 90., -18., 90. })); 
//    run->AddModule(new R3BFi6("fi6_OneLayer_c.geo.root", { -154.5, 0., 771.4 }, { "", 90., 27., 90. })); 
    ...
    {
        R3BIonGenerator* boxGen = new R3BIonGenerator(6, 12, 6, 1, 0., 0., 0.394259);//500 AMeV
	boxGen->SetSpotRadius(0.0,-200.,0.);
