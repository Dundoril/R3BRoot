...
ClassImp(R3BFi3ContFact)

static R3BFi3ContFact gR3BFi3ContFact;

R3BFi3ContFact::R3BFi3ContFact() {
  // Constructor (called when the library is loaded)
  fName="R3BFi3ContFact";
  fTitle="Factory for parameter containers in libR3BdTof";
  setAllContainers();
  FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi3ContFact::setAllContainers() {
   ...
   *  the list of containers for the STS library.*/
    ...
    */
    ...
    FairContainer* p2 = new FairContainer("fi3GeoPar", "Fi3 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi3ContFact::createContainer(FairContainer* c) {
...
void  R3BFi3ContFact::activateParIo(FairParIo* io) {
