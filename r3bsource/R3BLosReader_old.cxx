...
*/
//  cout<<"LOS READER, HERE WE START"<<endl;
...
//	cout<<"LOS Reader, iChannel: "<<channel<<", "<<channelT<<endl;	
			
			uint32_t nextChannelStart=data->LOS[d].VTFME[i];  // index in v for first item of next channel
			uint32_t nextChannelStartT=data->LOS[d].TTFLME[i];

      //     cout<<"READER: "<<curChannelStart<<", "<<nextChannelStart<<", "<<data->LOS[d].TTFLME[i]<<endl;
...
// cout<<"R3BReader fMapped array: "<<channel<<", "<<itype<<", "<<fine_times[itype]<<", "<<coarse_times[itype]<<endl;
